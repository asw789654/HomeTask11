...
LogEntry[] filteredLogs = LogProcessor.FilterByLevel(logs, LogEntry.LogLevel.Warning);
...
LogEntry[] filteredByTime = LogProcessor.FindRecentLogs(logs, DateTime.Parse("22.05.2018"));
